# -*- coding: utf-8 -*-
"""Tarani_Chilamkoti_Midterm_project

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1nFhfv1a5moHPmy7w-gtD_tsbptiXeqKW
"""
...
# Dataset Mapping with Google Drive file IDs
dataset_mapping = {
    "1": ("Amazon", "1_Sl4H0BGjPvBXojeiZrzWH1eWTSZ0NNJ"),
    "2": ("Best Buy", "1nHPfJK6lF4NW3p7jbz4revCm-dgVU9ZO"),
    "3": ("Generic Items", "1t7utYPsVSY3J4_P_ldECgUIO0NIs5Bf8"),
    "4": ("K-Mart", "1JIqcX3FE1H6j0MBZc44Nz1maAdsPGqBT"),
    "5": ("Nike", "1BBIBZYnZV4VTCs8SkfUS1QLa0Zm2Vjr2")
}

# Display dataset options
print("Select a dataset to process:")
for num, (name, _) in dataset_mapping.items():
    print(f"{num}. {name}")

# Ask the user for dataset input
file_number = input("Enter the number corresponding to the dataset (1-5): ")

# Validate input
if file_number not in dataset_mapping:
    print("Invalid input. Please enter a number between 1 and 5.")
    exit()

# Extract dataset info
dataset_name, file_id = dataset_mapping[file_number]

data_file = f"{dataset_name.replace(' ', '_')}.csv"
...
if not os.path.exists(data_file):
    print(f"Error: File {data_file} ({dataset_name}) not found.")
    exit()
...
# Process dataset
print(f"\nProcessing dataset: {dataset_name} ({data_file})")
transactions = load_dataset(data_file)
